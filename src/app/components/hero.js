...
const Hero = () => {
  ...
  React.useEffect(() => {
    // Set screen height for animations
  ...
  return (
    <section className="relative z-10 flex h-[100vh] w-full flex-col overflow-hidden bg-primary-light px-10 py-10 dark:bg-primary-dark xl:flex-row">
      <motion.article
        style={{ translateY: y1 }}
